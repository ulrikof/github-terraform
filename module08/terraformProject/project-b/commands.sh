...
az storage blob delete --account-name uo1backend1sa5hl8swws --container-name uo-sc-backend --name project_a.tfstate
az storage blob delete --account-name uo1backend1sa5hl8swws --container-name uo-sc-backend --name project_b.tfstate